...
Another limitation was the choice to restrict our pitch by pitch data to the 2019 season. The benefit of this choice was that the 2019 data alone includes 743,495 observations, so additional seasons would quickly create a very large data set. The drawback is that we are unable to verify if the results of our analyses are consistent across years.
